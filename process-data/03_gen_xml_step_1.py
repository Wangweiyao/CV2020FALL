...
def gen_template():
    ...
    folder.text = 'UECFOOD100/1'

    filename = ET.SubElement(root, 'filename')
    filename.text = '1.jpg'

    path = ET.SubElement(root, 'path')
    path.text = '/home/weiyao/data/UECFOOD100/1/1.jpg'
...
def write_xml(line, i_folder, category):
    if not os.path.exists('/home/weiyao/data/UECFOOD100/' + str(i_folder) + '/annotations_new/'):
        os.makedirs('/home/weiyao/data/UECFOOD100/' + str(i_folder) + '/annotations_new')

    anno_path = '/home/weiyao/data/UECFOOD100/' + str(i_folder) + '/annotations_new/' + line[0] + '.xml'

    if not os.path.isfile(anno_path):
        root = ET.Element('annotation', verified='yes')

        folder = ET.SubElement(root, 'folder')
        folder.text = '/home/weiyao/data/UECFOOD100/' + str(i_folder)

        filename = ET.SubElement(root, 'filename')
        filename.text = line[0] + '.jpg'

        path = ET.SubElement(root, 'path')
        path.text = '/home/weiyao/data/UECFOOD100/' + str(i_folder) + '/' + line[0] + '.jpg'
...
def read_category():
    category = []
    with open('/home/weiyao/data/UECFOOD100/category.txt', 'r') as file:
...
def rm_anno_dir():
    ...
    for i in range(1, 257):
        if os.path.exists('/home/weiyao/data/UECFOOD100/' + str(i) + '/annotations_new'):
            shutil.rmtree('/home/weiyao/data/UECFOOD100/' + str(i) + '/annotations_new')
    print('Done!')
...
def gen_xmls():
    ...
    for i_folder in range(1, num_classes + 1):
        imagepath = '/home/weiyao/data/UECFOOD100/' + str(i_folder)
